...
/**
 * WPUM_Field_Type_Name_Display Class
 *
 * @since 1.0.0
 */
class WPUM_Field_Type_Name_Display extends WPUM_Field_Type {
	...
	public function __construct() {
		...
		$this->name              = _x( 'Name Display', 'field type name', 'wpum' );
		// Field type name
...
new WPUM_Field_Type_Name_Display;
